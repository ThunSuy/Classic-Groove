        ...
        switch ($_GET['action']) {
            case 'getSales':
                ...
                $sql = "SELECT $select AS $as, SUM(tongTien) AS total
                        FROM hoadon WHERE trangThai = 'Successful'
            ...
            case 'getTopCustomers':
                ...
                $sql = "SELECT nguoidung.maNguoiDung AS tenKhachHang, SUM(hoadon.tongTien) AS tongDoanhThu
                            ...
                            WHERE hoadon.trangThai = 'Successful'
                              AND hoadon.thoiGianDat >= '$dateStart'
                              AND hoadon.thoiGianDat <= '$dateEnd'
                            GROUP BY hoadon.khachHang

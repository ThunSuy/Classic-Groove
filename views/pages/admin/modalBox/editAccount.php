        ...
        <div class="modal-info">
            ...
            <!-- <div class="modal-item">
                ...
                <div class="item-input">
                    <input type="text" value="?= $account['TrangThai'] == 1 ? 'Hoạt động' : 'Khóa'; ?>">
                </div>
            </div> -->
            ...
            <div class="modal-item">
                <div class="item-header">Status</div>
                <div class="item-input">
                    <select id="accountStatus" name="TrangThai" onchange="isAccountInfoChange()">
                        <option value="1" <?= $account['TrangThai'] == 1 ? 'selected' : '' ?>>Active</option>
                        <option value="0" <?= $account['TrangThai'] == 0 ? 'selected' : '' ?>>Locked</option>
                    </select>
                </div>
            </div>

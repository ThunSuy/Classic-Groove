                ...
                <div class="modal-item">
                    ...
                    <div class="item-input">
                        <!-- <input type="text" class="albumQuanitity"
                            ...
                            disabled> -->
                        <select name="TrangThai" class="albumStatus">
                            <option value="1" <?= $album['TrangThai'] == 1 ? 'selected' : '' ?>>Active</option>
                            <option value="0" <?= $album['TrangThai'] == 0 ? 'selected' : '' ?>>Inactive</option>
                        </select>
                    </div>
                </div>

            ...
            <div class="modal-info">
                ...
                <div class="modal-item">
                    ...
                    <div class="item-input">
                        <input type="text" class="albumQuanitity"
                            value="<?= intval($album['TrangThai']) === 1 ? 'Active' : 'Inactive' ?>"
                            disabled>
                    </div>
                </div>
...
function isAlbumInOrder($albumID)
{
    global $dp;
    ...
    if ($result && $result->num_rows > 0) {
        return true; // Album đã được đặt
    } else {
        return false; // Album chưa từng có trong đơn hàng
    }
}
